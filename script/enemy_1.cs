 ...
 * 
 * 1-> defined area patrolling , no player detection (DONE)
 * 2-> player pathfinding,  aerial attack , IDLE-> ENEMY DETECTION TRIGGER (NOT DONE)
 * 3-> idle patrol to ground attack , player detection trigger (NOT DONE)
 * 4-> NPC dialogue (NOT DONE)
 * 5-> BOSS-> 2 attacks (NOT DONE)
 *      1) close range(NORMAL) 2) long range + short range(ENRAGED)
 * 
 */
    ...
    IEnumerator SpawnMonsters()
    {
        for(int i=0;i<1;i++)
        {
          ...
          //  randomIndex = 0;
            ...
            spawnedcollectable = Instantiate(collectables[0]);
