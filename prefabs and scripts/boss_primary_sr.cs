...
public class boss_primary_sr : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (distToPlayer <= range && !enraged)
        {
            animator.SetBool("inRange", true);
        }
        else if(distToPlayer > range && !enraged)
        {
            animator.SetBool("inRange", false);
        //    animator.SetBool("isEnraged", false);
            Petrol();
        }
        else if(distToPlayer <=enraged_range && enraged)
        {
